package unificado.core.service.balance.service;
...
import unificado.core.service.extern.negocio.core.balance.NegocioCoreBalanceService;
...
public class BalanceService {
    ...
    private final NegocioCoreBalanceService negocioCoreBalanceService;
    ...
    private Mono<Optional<String>> processSingleCuentaNegocio(CuentaNegocio cuentaNegocio, OffsetDateTime desde, OffsetDateTime hasta, Boolean incluyeApertura, Boolean incluyeInflacion) {
        ...
        return negocioCoreBalanceService.totalesEntreFechasByNegocio(
