...
# El pom.xml define <finalName>unificado.core-service</finalName>
COPY --from=build /app/target/unificado.core-service.jar ./unificado.core-service.jar
...
ENTRYPOINT ["java", "-jar", "unificado.core-service.jar"]
